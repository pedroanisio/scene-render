...
CORE_SOURCES := src/common.c src/card.c src/parallel.c src/color.c src/raster.c src/vector_path.c src/mesh.c src/gpu.c src/spatial.c src/diagnostics.c src/timeline.c src/property.c src/scene.c \
...
UNIT_SUITES := timeline geometry compositor color vector mesh scene property xml profile \
