...
CORE_SOURCES := src/common.c src/card.c src/parallel.c src/color.c src/raster.c src/vector_path.c src/mesh.c src/gpu.c src/spatial.c src/diagnostics.c src/timeline.c src/curves.c src/property.c src/scene.c \
	...
	src/xml_camera.c \
	src/xml_visual.c \
	src/xml_physics.c src/xml_styles.c src/xml_schema.c src/xml_capabilities.c src/cli_args.c
...
UNIT_SUITES := timeline curves geometry compositor color vector mesh scene property xml profile styles \
