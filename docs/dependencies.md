...
| libxml2 (`libxml-2.0`) | ≥ 2.9.1 | 2.14.6 | runtime XSD validation against the embedded `schema/scene-v1.xsd` (`src/xml_schema.c`); no network, no external entities, no DTD loading | MIT |
