...
static const SrProperty properties[] = {
    ...
    NUMBER(NODES, SrNode, transform.anchor_x, "anchor.x", "anchorX", 0),
    NUMBER(NODES, SrNode, transform.anchor_y, "anchor.y", "anchorY", 0),
    ...
    NUMBER(H(MASK), SrMask, x, "x", "x", 0),
    NUMBER(H(MASK), SrMask, y, "y", "y", 0),
    NUMBER(H(MASK), SrMask, width, "width", "width", 0),
    NUMBER(H(MASK), SrMask, height, "height", "height", 0),
